...
window.onload = function () {
    document.getElementById("btnNew").onclick = () => { new window.ToastENotifier({ text: "hi", loaderBgColor: "#Bada55", showHideTransition: "expand", beforeShow: (el) => { console.log(el); el.style.display = ""; } }) };
}